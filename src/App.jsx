        ...
        <AuthProvider>
            <Router>
                <Routes>
                    ...
                    <Route path="/materials" element={<Materials />} /> {/* Add material page route if needed */}
                    <Route path="/calendar" element={<Calendar />} /> {/* Add calendar page route if needed */}
                    <Route path="/task-progress" element={<TaskProgress />} /> {/* Add task progress page route if needed */}
                    <Route path="/task-timeline" element={<TaskTimeline />} /> {/* Add task timeline page route if needed */}
